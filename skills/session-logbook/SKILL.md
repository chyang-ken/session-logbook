...
description: >
  Use local Claude Code, Codex, and Kimi Code session records when the user wants an Agent to absorb
...
Useful search filters are `--source claude|codex|kimi`, `--project <substring>`, `--since 7d`
