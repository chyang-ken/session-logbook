...
The primary browser surface should be one reverse-chronological timeline across projects, with
...
filter. A suspicion is not a fact: the user must be able to reveal the filtered results and mark a
